...
@Component({
  ...
  template: `
    ...
    >
      <div
        class="absolute inset-0 bg-[url('https://assets.codepen.io/13471/sparkles.gif')] opacity-40 mix-blend-screen pointer-events-none"
      ></div>
      <div
        class="absolute w-full h-full bg-gradient-to-b from-gray-900/10 via-[#050b14]/90 to-cyber-bg z-0"
      ></div>
      <div
      ...
      <div
        class="bg-white/5 border border-white/20 p-6 md:p-8 rounded-2xl w-full max-w-lg backdrop-blur-sm relative z-10 shadow-[0_0_50px_rgba(0,243,255,0.1)]"
      >
        <div class="text-center mb-8 relative">
          ...
          ></div>
          <h1
            class="text-3xl md:text-4xl font-bold text-white mb-2 tracking-wider drop-shadow-[0_0_10px_rgba(0,243,255,0.5)]"
          >
            IDENTIFY YOURSELF
          </h1>
